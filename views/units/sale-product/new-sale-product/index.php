...
<body>
            ...
            <div class="col-xl-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <?php require $this->pathPhp."arayuz/forms/new/formNewSaleProduct.php"; ?>
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/sale-product/new-sale-product/new-sale-product.js"></script>
