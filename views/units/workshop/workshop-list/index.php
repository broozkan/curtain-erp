...
<body>
            ...
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                    Atölyelar Listesi
                    <a href="<?php echo $this->pathHtml; ?>workshop/new-workshop" class="btn btn-primary btn-sm float-right"> <span class="fa fa-plus"></span> Yeni Atölye Ekle</a>
                  </h4>
                  <p class="card-subtitle mb-4">Atölyelarınızın listesine buradan ulaşabilirsiniz</p>
                  <div class="table-responsive">
                    <form class="form-inline frmTableSearch" model="workshop" action="" method="post">
                    ...
                    <table class="table mb-0" id="workshop-list" model="workshop" is-override="false" page-number="1" item-per-page="1" >
                      <thead class="thead-light">
                        <tr>
                          <th>#</th>
                          <th>Atölye Adı</th>
                          <th>Atölye Adresi</th>
                          <th>Atölye Telefon Numarası</th>
                          <th>Atölye E-Posta Adresi</th>
                          <th>İşlem</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <?php
                        // for ($i=0; $i < count($this->workshops); $i++) {
                          // echo '<tr id='.$this->workshops[$i]["workshop_id"].'">';
                          // echo '<td>'.$this->workshops[$i]["workshop_id"].'</td>';
                          // echo '<td>'.$this->workshops[$i]["workshop_name"].'</td>';
                          // echo '<td>'.$this->workshops[$i]["workshop_phone_number"].'</td>';
                          // echo '<td>'.$this->workshops[$i]["workshop_email"].'</td>';
                          // echo '<td>'.$this->workshops[$i]["workshop_username"].'</td>';
                          // echo '<td>';
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/workshop/workshop-list/workshop-list.js"></script>
