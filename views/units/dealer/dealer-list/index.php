...
<body>
            ...
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <p class="card-subtitle mb-4">Bayilarınızın listesine buradan ulaşabilirsiniz</p>
                  <div class="table-responsive">
                    <form class="form-inline frmTableSearch" model="dealer" action="" method="post">
                      <div class="form-group">
                        <label for="txtDealerName">Bayi Adı : </label>
                        <input type="text" class="form-control" name="txtDealerName" id="txtDealerName" value="">
                      </div>
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-sm" name="button">Ara</button>
                      </div>
                    </form>
                    <table class="table mb-0" id="dealer-list" model="dealer" is-override="false" page-number="1" item-per-page="1" >
                      ...
                      <tbody>
                        ...
                        // for ($i=0; $i < count($this->dealers); $i++) {
                          // echo '<tr id='.$this->dealers[$i]["dealer_id"].'">';
                          // echo '<td>'.$this->dealers[$i]["dealer_id"].'</td>';
                          // echo '<td>'.$this->dealers[$i]["dealer_name"].'</td>';
                          // echo '<td>'.$this->dealers[$i]["dealer_phone_number"].'</td>';
                          // echo '<td>'.$this->dealers[$i]["dealer_email"].'</td>';
                          // echo '<td>'.$this->dealers[$i]["dealer_username"].'</td>';
                          // echo '<td>';
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/dealer/dealer-list/dealer-list.js"></script>
