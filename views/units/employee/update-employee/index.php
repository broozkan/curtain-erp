...
<body>
            ...
            <div class="col-xl-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Çalışan Bilgilerini Düzenle</h4>
                  <p class="card-subtitle mb-4">Çalışanınızın bilgilerini buradan düzenleyebilirsiniz.</p>
                  ...
                  <form id="frmUpdateEmployee" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="hidden" name="txtEmployeeId" value="<?php echo $this->employeeInformations["employee_id"]; ?>">
                      <input value="<?php echo $this->employeeInformations["employee_name"]; ?>" type="text" class="form-control" name="txtEmployeeName" id="txtEmployeeName" required>
                    </div>
                    <!-- form group -->
                    <!-- form group -->
                    <div class="form-group">
                      <label for="txtEmployeePhoneNumber">Çalışan Telefon Numarası </label>
                      <input value="<?php echo $this->employeeInformations["employee_phone_number"]; ?>" type="text" class="form-control mobile-phone-number" name="txtEmployeePhoneNumber" id="txtEmployeePhoneNumber">
                    </div>
                    <!-- form group -->
                    <!-- form group -->
                    <div class="form-group">
                      <label for="txtEmployeeEmail">Çalışan E-posta Adresi </label>
                      <input value="<?php echo $this->employeeInformations["employee_email"]; ?>" type="text" class="form-control email" name="txtEmployeeEmail" id="txtEmployeeEmail">
                    </div>
                    <!-- form group -->
                    <!-- form group -->
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input value="<?php echo $this->employeeInformations["employee_redirect_url"]; ?>" type="text" class="form-control" name="txtEmployeeRedirectUrl" id="txtEmployeeRedirectUrl">
                    </div>
                    <!-- form group -->
                    <hr>
                    ...
                    <div class="form-group">
                      ...
                      <input value="<?php echo $this->employeeInformations["employee_username"]; ?>" type="text" class="form-control" name="txtEmployeeUsername" id="txtEmployeeUsername" aria-describedby="txtEmployeeUsernameHelp">
                    ...
                    <div class="form-group mb-3">
                      <div class="custom-control custom-checkbox">
                        <?php
                          if (in_array("txtEmployeeCanSale",$this->employeeInformations["employee_permissions"])) {
                            echo '<input type="checkbox" checked class="custom-control-input" name="txtEmployeePermissions[]" id="txtEmployeeCanSale" value="txtEmployeeCanSale">';
                          }else {
                            echo '<input type="checkbox" class="custom-control-input" name="txtEmployeePermissions[]" id="txtEmployeeCanSale" value="txtEmployeeCanSale">';
                          }
                        ?>
                    ...
                    <div class="form-group mb-3">
                      <div class="custom-control custom-checkbox">
                        <?php
                          if (in_array("txtEmployeeCanInvoice",$this->employeeInformations["employee_permissions"])) {
                            echo '<input type="checkbox" checked class="custom-control-input" name="txtEmployeePermissions[]" id="txtEmployeeCanInvoice" value="txtEmployeeCanInvoice">';
                          }else {
                            echo '<input type="checkbox" class="custom-control-input" name="txtEmployeePermissions[]" id="txtEmployeeCanInvoice" value="txtEmployeeCanInvoice">';
                          }
                        ?>
                    ...
                    <button type="submit" class="btn btn-primary btnLoadingUpdateEmployee">Kaydet</button>
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/employee/update-employee/update-employee.js"></script>
