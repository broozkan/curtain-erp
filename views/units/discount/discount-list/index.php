...
<body>
            ...
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                    İndirimler Listesi
                    <a href="<?php echo $this->pathHtml; ?>discount/new-discount" class="btn btn-primary btn-sm float-right"> <span class="fa fa-plus"></span> Yeni İndirim Ekle</a>
                  </h4>
                  <p class="card-subtitle mb-4">İndirimlerınızın listesine buradan ulaşabilirsiniz</p>
                  <div class="table-responsive">
                    <form class="form-inline frmTableSearch" model="discount" action="" method="post">
                      <div class="form-group">
                        <label for="txtDiscountName">İndirim Adı : </label>
                        <input type="text" class="form-control" name="txtDiscountName" id="txtDiscountName" value="">
                      </div>
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-sm" name="button">Ara</button>
                      </div>
                    </form>
                    <table class="table mb-0" id="discount-list" model="discount" is-override="false" page-number="1" item-per-page="1" >
                      ...
                      <tbody>
                        ...
                        // echo '<tr id='.$this->discounts[$i]["discount_id"].'">';
                        // echo '<td>'.$this->discounts[$i]["discount_id"].'</td>';
                        // echo '<td>'.$this->discounts[$i]["discount_name"].'</td>';
                        // echo '<td>'.$this->discounts[$i]["discount_phone_number"].'</td>';
                        // echo '<td>'.$this->discounts[$i]["discount_email"].'</td>';
                        // echo '<td>'.$this->discounts[$i]["discount_username"].'</td>';
                        // echo '<td>';
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/discount/discount-list/discount-list.js"></script>
