...
<body>
            ...
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                    Ürünlar Listesi
                    <a href="<?php echo $this->pathHtml; ?>stock-product/new-stock-product" class="btn btn-primary btn-sm float-right"> <span class="fa fa-plus"></span> Yeni Ürün Ekle</a>
                  </h4>
                  <p class="card-subtitle mb-4">Ürünlarınızın listesine buradan ulaşabilirsiniz</p>
                  <div class="table-responsive">
                    <form class="form-inline frmTableSearch" model="stock_product" action="" method="post">
                      <div class="form-group">
                        <label for="txtStockProductName">Ürün Adı : </label>
                        <input type="text" class="form-control" name="txtStockProductName" id="txtStockProductName" value="">
                      </div>
                      <div class="form-group">
                        <label for="txtStockProductCategoryId">Ürün Kategorisi : </label>
                        <select class="form-control" name="txtStockProductCategoryId" id="txtStockProductCategoryId">
                    ...
                    <table class="table mb-0" id="stock-product-list" model="stock_product" is-override="false" page-number="1" item-per-page="10" >
                      <thead class="thead-light">
                        <tr>
                          <th>#</th>
                          <th>Stok Ürünü Adı</th>
                          <th>Stok Ürünü Kategorisi</th>
                          <th>Stok Ürünü Deposu</th>
                          <th>İşlem</th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        // for ($i=0; $i < count($this->products); $i++) {
                          // echo '<tr id='.$this->products[$i]["stock_product_id"].'">';
                          // echo '<td>'.$this->products[$i]["stock_product_id"].'</td>';
                          // echo '<td>'.$this->products[$i]["stock_product_name"].'</td>';
                          // echo '<td>'.$this->products[$i]["stock_product_phone_number"].'</td>';
                          // echo '<td>'.$this->products[$i]["stock_product_email"].'</td>';
                          // echo '<td>'.$this->products[$i]["stock_product_username"].'</td>';
                          // echo '<td>';
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/stock-product/stock-product-list/stock-product-list.js"></script>
