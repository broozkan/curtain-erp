          ...
          <div class="row">
            ...
            <div class="col-sm-8">
              <div class="text-left mt-4">
                <h4><?php echo $this->supplierInformations["supplier_name"]; ?></h4>
                <p class="text-muted mt-3 mb-4"><?php echo $this->supplierInformations["supplier_email"]; ?></p>
                <p class="text-muted mt-3 mb-4"><?php echo $this->supplierInformations["supplier_phone_number"]; ?></p>
...
<script src="<?php echo $this->pathHtml; ?>views/units/supplier/supplier-profile/supplier-profile.js"></script>
