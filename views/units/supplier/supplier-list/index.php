...
<body>
          ...
          <div class="row">
            <div class="col-xl-12">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">
                    Tedarikçilar Listesi
                    <a href="<?php echo $this->pathHtml; ?>supplier/new-supplier" class="btn btn-primary btn-sm float-right"> <span class="fa fa-plus"></span> Yeni Tedarikçi Ekle</a>
                  </h4>
                  <p class="card-subtitle mb-4">Tedarikçilarınızın listesine buradan ulaşabilirsiniz</p>
                  <div class="table-responsive">
                    <form class="form-inline frmTableSearch" model="supplier" action="" method="post">
                    ...
                    <table class="table mb-0" id="supplier-list" model="supplier" is-override="false" page-number="1" item-per-page="1" >
                      ...
                      <tbody>
                        ...
                        // for ($i=0; $i < count($this->suppliers); $i++) {
                          // echo '<tr id='.$this->suppliers[$i]["supplier_id"].'">';
                          // echo '<td>'.$this->suppliers[$i]["supplier_id"].'</td>';
                          // echo '<td>'.$this->suppliers[$i]["supplier_name"].'</td>';
                          // echo '<td>'.$this->suppliers[$i]["supplier_phone_number"].'</td>';
                          // echo '<td>'.$this->suppliers[$i]["supplier_email"].'</td>';
                          // echo '<td>'.$this->suppliers[$i]["supplier_username"].'</td>';
                          // echo '<td>';
  ...
  <script src="<?php echo $this->pathHtml; ?>views/units/supplier/supplier-list/supplier-list.js"></script>
