...
<body>
            ...
            <div class="col-xl-6">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <h4 class="card-title">Yeni Kredi Ekle</h4>
                  <p class="card-subtitle mb-4">Yeni bir çalışanınızı buradan ekleyebilirsiniz.</p>

                  <?php require $this->pathPhp."arayuz/forms/new/formNewCredit.php"; ?>
  ...
  <script src="<?php echo $this->pathHtml; ?>views/apps/accounting/credit/new-credit/new-credit.js"></script>
