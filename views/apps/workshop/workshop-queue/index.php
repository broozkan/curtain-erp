...
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <form class="form-inline frmCustomTableSearch" model="workshop" action="" method="post">
                      ...
                      <div class="form-group d-none">
                        <label for="txtSearchWorkshopId">Atölye : </label>
                        <input type="text" class="form-control" name="txtSearchWorkshopId" id="txtSearchWorkshopId" value="<?php echo $this->workshopInformations["workshop_id"]; ?>">
                      </div>
                      <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-sm" name="button">Ara</button>
                      </div>
                    </form>
                    <table class="table mb-0 tbl-todays-works" id="workshop-queue" function="workshop-queue" model="workshop" is-override="true" page-number="1" item-per-page="10" override-function="overrideWorkshopQueue" >
  ...
  <?php require $this->pathPhp."arayuz/modals/modalVerifySaleWorkshop.php"; ?>

  <?php require $this->pathPhp."arayuz/script.php"; ?>
  <script src="<?php echo $this->pathHtml; ?>views/apps/workshop/workshop-queue/workshop-queue.js"></script>
